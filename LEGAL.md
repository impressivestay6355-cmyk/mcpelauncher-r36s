...
"Xbox Live" are trademarks of Microsoft. This project is **not affiliated
with, sponsored by, or endorsed by** Mojang Studios, Microsoft, or Xbox.
It is distributed for interoperability and homebrew purposes only.

## Upstream license

The launcher this port packages is derived from
[minecraft-linux/mcpelauncher-manifest](https://github.com/minecraft-linux/mcpelauncher-manifest),
licensed under GPL-3.0. This port is distributed under the same license —
see [LICENSE](LICENSE). Copyright and license notices of the upstream
project are preserved; see [CREDITS.md](CREDITS.md) for attribution.
...
or implied, per the terms of the GPL-3.0 license in [LICENSE](LICENSE).
